...
const Banner = () => {
  ...
  return (
    <>
      {weatherData.loading && (
        <div className="relative bg-[#272541ff] w-[343px] h-[286px] md:w-[800px] rounded-xl">
          <div className="absolute flex flex-col md:flex-row top-1/2 left-1/2 transform-[translate(-50%,-50%)] items-center justify-center w-full">
            <div className="p-2.5">
        ...
        Object.keys(weatherData.weatherDataa).length > 0 && (
          <div className="relative">
            <picture>
              ...
              <img src={mobileImage} className="w-full" />
            </picture>
